...
class ContentController extends Controller
{
    public function __construct(
        ...
        private readonly MaterialIngestionService      $materialIngestionService,
    ...
    public function store(Request $request)
    {
        ...
        try {
            $storagePath = $this->materialUploadService->upload($request->file('file'), $request->lesson_id);
    ...
    public function reprocess(Request $request, LearningMaterial $material)
    {
        ...
        try {
            $count = $this->materialIngestionService->ingest($material);
